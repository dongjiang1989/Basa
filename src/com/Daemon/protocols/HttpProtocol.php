...
require_once(dirname(__FILE__)."/../connection/TcpConnection.php");
require_once(dirname(__FILE__)."/Protocolinterface.php");
/**
* http protocol
...
class HttpProtocol
{
    ...
    */
    ...
    {
        return dirname(__FILE__).'/mime.types';
    }
