...
class Person extends PBMessage
{
  ...
  public function __construct($reader=null)
  {
    ...
    $this->values["6"] = array();
    $this->names_type["9"] = "phone2";
    $this->fields["9"] = "Person_PhoneNumber";
    $this->values["9"] = "";
  }
  function name()
  {
  ...
  function set_phone2($index, $value)
  {
    $this->_set_arr_value("9", $index, $value);
  }
  function remove_last_phone2()
  {
    $this->_remove_last_arr_value("9");
  }
  function phone2_size()
  {
