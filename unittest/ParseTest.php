...
class ParseTest extends PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
      $this->yaml = spyc_load_file(dirname(__FILE__).'/spyc.yaml');
    }
    ...
    public function testMergeHashKeys() {
      ...
      $Actual = spyc_load_file (dirname(__FILE__).'/indent_1.yaml');
...
dog', $this->yaml['many_lines']);
    ...
    public function testAngleQuotes() {
      $Quotes = Spyc::YAMLLoad(dirname(__FILE__).'/quotes.yaml');
    ...
    public function testFailingColons() {
      $Failing = Spyc::YAMLLoad(dirname(__FILE__).'/failing1.yaml');
    ...
    public function testQuotesWithComments() {
      $Expected = 'bar';
      $Actual = spyc_load_file (dirname(__FILE__).'/comments.yaml');
