...
class TestKfcServerPlugin extends PHPUnit_Framework_TestCase  {
    ...
    function test_start() {
        ...
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "input"), 'aaaaaaaaaaaaaaaaaaaaa');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "input"), 'aaaaaaaaaaaaaaaaaaaaa');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "input"), 'aaaaaaaaaaaaaaaaaaaaa');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "input"), 'aaaaaaaaaaaaaaaaaaaaa');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "input"), 'aaaaaaaaaaaaaaaaaaaaa');
        ...
        $ret = $this->_mock->run("cat /dev/kuafu_alive");
        logging::error($ret);
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "input"), 'bbbbbbb');
    ...
    function test_server() {
        ...
        $ret = $this->_mock->run("cat /dev/kuafu_alive");
        logging::error($ret);
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "1"), 'aaa');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "3"), 'ccc');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "1"), 'aaa');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "2"), 'bbb');
        $this->assertEquals(Request::SendRequestBykfc("apple", "/tmp/agt.sock", "iadasd"), 'ddd');
